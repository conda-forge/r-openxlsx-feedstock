...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/r-openxlsx-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-openxlsx-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi global install r-openxlsx
```
...
It is possible to list all of the versions of `r-openxlsx` available on your platform:
...
```
pixi search r-openxlsx --channel conda-forge
```
